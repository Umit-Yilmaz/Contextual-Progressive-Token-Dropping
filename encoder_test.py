...
# Production fix: official.projects.token_dropping is not distributed in
# tf-models-official 2.10.1.  Import the local encoder.py instead.
...
class TokenDropBertEncoderTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_dict_outputs_network_creation(self):
    ...
    test_network = TokenDropBertEncoder(
        vocab_size=100,
