...
Production fix: replaced
    from official.projects.token_dropping import encoder_config
    from official.projects.token_dropping import masked_lm
with local-module imports.  official.projects.token_dropping is not distributed
in tf-models-official 2.10.1.

Only pretraining configs.  Token dropping BERT checkpoints share the same
structure as standard BERT and can be used directly for fine-tuning.
"""
...
# ── Local imports (replace official.projects.token_dropping.*) ────────────────
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))
if _THIS_DIR not in sys.path:
    sys.path.insert(0, _THIS_DIR)

from encoder_config import TokenDropBertEncoderConfig   # noqa: E402
from masked_lm import TokenDropMaskedLMConfig            # noqa: E402
